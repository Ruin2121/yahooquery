...
```bash
pip install "yahooquery @ git+https://github.com/Ruin2121/yahooquery.git@2.3.7r11"
```
...
```bash
pip install "yahooquery[premium] @ git+https://github.com/Ruin2121/yahooquery.git@2.3.7r11"
```
